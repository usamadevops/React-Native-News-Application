...
import { errorSelector, isLoadingSelector } from '../../redux/Modules/auth/selector.auth';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.InnerContainer}>
                ...
                <View style={{ flexWrap: 'nowrap', marginTop: 5 }}>
                    <Text style={styles.subHeaderText}>Open your Email to view the Code😉</Text>
                </View>
            </View>
            ...
            <View style={styles.inputOuterContainer}>
                <TextInput
                    ...
                    style={[styles.inputInnerContainer,{backgroundColor:errorExist?`${theme.colors.Red}30`:null, borderColor:errorExist?theme.colors.Red:theme.colors.MediumGray}]}
                    maxLength={6}
                    value={code}
